  ...
  return (
    <div className="space-y-4 max-w-full">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h1 className="text-2xl font-bold text-slate-100">Lots</h1>
          <p className="text-sm text-slate-500">{total} lots found</p>
        </div>
        <div className="flex gap-2 flex-wrap">
          ...
          <button onClick={() => setShowUpload(true)} className="btn-secondary text-sm">Upload CSV</button>
      ...
      <div className="flex gap-3 flex-wrap items-end">
        <div className="flex-1 min-w-[200px]">
          <input
            type="text"
            placeholder="Search owner, address, parcel ID..."
            value={search}
